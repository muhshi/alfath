...
- [x] Task 1: Buat Controller `PengolahanController.php` dengan query gabungan (Monitoring SE2026 + Usaha Perusahaan + Usaha Keluarga + Pemutakhiran Keluarga) yang mendukung Search, Filter Kecamatan, & Dynamic Column Sorting
- [x] Task 2: Tambahkan rute `Route::get('/dashboard-pengolahan', ...)` di `routes/web.php`

### Phase 2: Frontend Design (Blade View)
- [x] Task 3: Buat Blade View `dashboard-pengolahan.blade.php` lengkap dengan kartu KPI, filter pencarian & kecamatan, header column sorting (▲/▼), tabel responsive, dan pagination
