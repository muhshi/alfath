...
- **Dashboard Tabel Petugas SE2026 (`/dashboard-pengolahan`)**:
  ...
  - Koreksi Perhitungan **Muatan Murni**: Mengabaikan data `se2026_usaha_keluarga` dan menetapkan formula `Muatan Murni = (Usaha Perusahaan Ditemukan + Baru) + (Keluarga Ditemukan + Baru)` sehingga nilai muatan murni selalu konsisten dan 100% presisi.
  ...
  - Interactive Column Sorting: Menyediakan pengurutan interaktif (Ascending/Descending ▲/▼) pada header tabel untuk kolom Kecamatan, Nama Petugas, Nama Pengawas (grouping), Beban Saat Ini, Total Submit, % Progres, Jumlah Usaha, Jumlah Keluarga, dan Muatan Murni.
